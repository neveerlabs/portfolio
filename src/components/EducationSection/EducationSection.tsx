  ...
  const education = [
    {
      ...
      icon: GraduationCap,
      details: [
        "Currently studying information technology while building practical software projects",
        "Focused on programming, web applications, systems, and developer tooling",
      ]
    },
    {
      degree: "Teknik Komputer dan Jaringan (TKJ)",
      school: "SMK Bumi Riyadhutholibin",
      year: "Lulus 2026",
      badge: "UKK Certified",
      badgeIcon: Sparkles,
      ...
      icon: BookOpen,
      details: [
        "Built a foundation in computer networking, hardware, and troubleshooting",
        "Completed the Uji Kompetensi Keahlian (UKK)",
        "Practiced LAN configuration and technical support workflows",
      ]
    }
  ];
      ...
      <div>
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            Formal education supporting my hands-on work in software, systems, and networking.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-5">
          {education.map((edu, i) => {
            ...
            return (
              ...
              >
                <MagicCard
                  className="h-full rounded-[2.25rem] border border-slate-200/80 bg-white/90 p-8 shadow-[0_18px_45px_rgba(15,23,42,0.08)] dark:border-border/80 dark:bg-card/80 dark:shadow-xl"
                >
